...
// AttachVolume provides a mock function with given fields: _a0, _a1
func (_m *mockClient) AttachVolume(_a0 string, _a1 int) (*godo.Action, *godo.Response, error) {
...
func (_m *mockClient) CreateVolume(_a0 *godo.VolumeCreateRequest) (*godo.Volume, *godo.Response, error) {
	ret := _m.Called(_a0)

	var r0 *godo.Volume
	if rf, ok := ret.Get(0).(func(*godo.VolumeCreateRequest) *godo.Volume); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*godo.Volume)
		}
	}

	var r1 *godo.Response
	if rf, ok := ret.Get(1).(func(*godo.VolumeCreateRequest) *godo.Response); ok {
		r1 = rf(_a0)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*godo.Response)
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(*godo.VolumeCreateRequest) error); ok {
		r2 = rf(_a0)
	} else {
		r2 = ret.Error(2)
	}
...
func (_m *mockClient) DeleteVolume(_a0 string) (*godo.Response, error) {
	ret := _m.Called(_a0)
...
// GetVolume provides a mock function with given fields: _a0
func (_m *mockClient) GetVolume(_a0 string) (*godo.Volume, *godo.Response, error) {
	ret := _m.Called(_a0)

	var r0 *godo.Volume
	if rf, ok := ret.Get(0).(func(string) *godo.Volume); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*godo.Volume)
